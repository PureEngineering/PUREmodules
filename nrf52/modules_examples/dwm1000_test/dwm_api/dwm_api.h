 ...
 * @return Error code
 */
int dwm_pos_get(ble_nus_t m_nus,dwm_pos_t* pos);
 ...
 * @return Error code
 */
int dwm_upd_rate_set(ble_nus_t m_nus,uint16_t ur, uint16_t urs);
 ...
 * @return Error code
 */
int dwm_upd_rate_get(ble_nus_t m_nus,uint16_t *ur, uint16_t *urs);
 ...
 * @return Error code
 */
int dwm_baddr_set(ble_nus_t m_nus,dwm_baddr_t* baddr);
 ...
 * @return Error code
 */
int dwm_baddr_get(ble_nus_t m_nus,dwm_baddr_t* baddr);
 ...
 * @return Error code
 */
int dwm_gpio_value_get(ble_nus_t m_nus,dwm_gpio_idx_t idx, bool* value);
