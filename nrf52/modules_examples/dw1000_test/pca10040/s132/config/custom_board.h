 ...
 *
 */
#ifndef NRF52_PUREMODULES_H
#define NRF52_PUREMODULES_H
...
#define LEDS_LIST { LED_1 } //, LED_1, LED_1, LED_1 }
...
#define BUTTONS_LIST { BUTTON_1 } //, BUTTON_1, BUTTON_1, BUTTON_1 }
...
#define SPIM2_SCK_PIN   25  // SPI clock GPIO pin number.
#define SPIM2_MOSI_PIN  23  // SPI Master Out Slave In GPIO pin number.
#define SPIM2_MISO_PIN  24  // SPI Master In Slave Out GPIO pin number.
#define SPIM2_SS_PIN    28  // SPI Slave Select GPIO pin number.
