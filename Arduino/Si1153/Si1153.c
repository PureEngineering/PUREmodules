...
void Si1153::param_set(uint8_t loc, uint8_t val){
	...
	while(1){
		int CMMND_CTR = Si1153::read_register(Si1153::DEVICE_ADDRESS,Si1153::RESPONSE0,1);

		packet[0] = Si1153::HOSTIN0;
		packet[1] = val;
		Si1153::write_data(Si1153::DEVICE_ADDRESS,packet,2);

		packet[0] = Si1153::COMMAND;
		packet[1] = loc | (0B10<<6);
		Si1153::write_data(Si1153::DEVICE_ADDRESS,packet,2);

		int response = Si1153::read_register(Si1153::DEVICE_ADDRESS,Si1153::RESPONSE0,1);
...
int Si1153::param_query(uint8_t loc){
	...
	while(1){
		...
		if(response>CMMND_CTR){
			result = Si1153::read_register(Si1153::DEVICE_ADDRESS,Si1153::RESPONSE1,1);
			break;
		}
	}	
	return result;
...
void Si1153::send_command(uint8_t code){
    ...
    while(1){
        ...
        int r = Si1153::read_register(Si1153::DEVICE_ADDRESS, Si1153::RESPONSE0, 1);
