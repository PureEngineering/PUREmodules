...
void loop() {
    ...
    data[0] = si1153.read_register(Si1153::DEVICE_ADDRESS, Si1153::HOSTOUT0);
    data[1] = si1153.read_register(Si1153::DEVICE_ADDRESS, Si1153::HOSTOUT1);
    data[2] = si1153.read_register(Si1153::DEVICE_ADDRESS, Si1153::HOSTOUT2);
    ...
    //channel3_data[0] = si1153.read_register(Si1153::DEVICE_ADDRESS, Si1153::HOSTOUT3);
    //channel3_data[1] = si1153.read_register(Si1153::DEVICE_ADDRESS, Si1153::HOSTOUT4);
    //channel3_data[2] = si1153.read_register(Si1153::DEVICE_ADDRESS, Si1153::HOSTOUT5);
