...
public class BluetoothLeService extends Service {
   ...
   // public static final UUID CCCD = UUID.fromString("00002902-1212-efde-1523-785fef13d123");
    ...
    private void broadcastUpdate(final String action,
        ...
        } else if (UUID_CH0_MEASUREMENT.equals(characteristic.getUuid())) {
    ...
    public void writeCustomCharacteristic(int value) {
        ...
        /*get the read characteristic from the service*/
        BluetoothGattCharacteristic mWriteCharacteristic = mCustomService.getCharacteristic(UUID.fromString("0000fdc0-1212-efde-1523-785fef13d123"));
